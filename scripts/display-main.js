...
// console.log(sortedStudentDataSub1);
// console.log(sortedStudentDataSub2);
// console.log(sortedStudentDataSub3);
// console.log(sortedStudentData);
console.log(sortedSub1);
// console.log(sortedSub2);
// console.log(sortedSub3);
var studentDataSub1 = [];
var studentDataSub2 = [];
var studentDataSub3 = [];
for (var i = 0; i < 50; i++){
...
var subjectDisplay = "sub1";
var compareDisplay = sortedSub1;


(function(){

  d3.select("sub2-button").on
  ...
  var studentColorScale = d3.scaleLinear()
    .domain([0, d3.max(studentDataSub1)])
    .range(["#FFEB3B", "#00BCD4"]);
  ...
  studentCanvas.selectAll("rect")
    .data(studentDataSub1)
    .enter()
    .append("rect")
      .attr("fill", function(d){ return studentColorScale(d); })
      .attr("width", studentBarWidth)
      // .attr("width", function(d){ return studentXScale.rangeRound(d)})
